            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="template-demo">
                  <h1>
                    {" "}
                    h1. Heading <small className="text-muted"> Secondary text </small>
                  </h1>
                  <h2>
                    {" "}
                    h2. Heading <small className="text-muted"> Secondary text </small>
                  </h2>
                  <h3>
                    {" "}
                    h3. Heading <small className="text-muted"> Secondary text </small>
                  </h3>
                  <h4>
                    {" "}
                    h4. Heading <small className="text-muted"> Secondary text </small>
                  </h4>
                  <h5>
                    {" "}
                    h5. Heading <small className="text-muted"> Secondary text </small>
                  </h5>
                  <h6>
                    {" "}
                    h6. Heading <small className="text-muted"> Secondary text </small>
                  </h6>
                </div>
              </div>
            </div>
          ...
          <div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <p>
                  {" "}
                  It is a long <mark className="bg-warning text-white">established</mark> fact that
          ...
          <div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <p>
                  {" "}
                  It is a long <span className="font-weight-bold">established fact</span> that a
          ...
          <div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <p>
                  <u>
                    lorem ipsum dolor sit amet, consectetur mod tempor incididunt ut labore et
                    dolore magna aliqua.
                  </u>
                </p>
              </div>
              <div className="card-body">
                ...
                <p className="text-lowercase">
                  {" "}
                  lorem ipsum dolor sit amet, consectetur mod tempor incididunt ut labore et dolore
                  magna aliqua.{" "}
                </p>
              </div>
              <div className="card-body">
